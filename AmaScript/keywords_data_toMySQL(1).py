...
def read_data(L):
    try:
        ...
        upload_file = pd.read_excel(final_path, sheet_name='SP')
...
def main():
    ...
    path = r"D:\Summary\关键词\20210712"
    # upload_path = r"D:\Summary\关键词\upload\upload-{0}{1}.xlsx".format(path[-10:-2], path[-1])
