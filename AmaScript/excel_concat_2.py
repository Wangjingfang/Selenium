...
def data_cleaning(total_file, final_path):
    try:
        ...
        #上架时间向上补全
        total_file['上架时间'] = total_file['记录时间'].fillna(method='ffill')
        total_file['上架时间'] = total_file['记录时间'].map(lambda x: str(x).split()[0])
        ...
        #
        '''
        "渠道来源",	"备货仓库",	"ASIN",	"SKU",	"自定义SKU",	"FNSKU",	"SellSKU",	"销售类型",	"销售小组",	"销售人员",	"上架人员",	
        "上架方式",	"记录时间",	"刊登时间",	"产品中文名称",	"完整中文类别",	"默认运输方式",	"备货天数",	"运输时间",	"安全天数",	"采购天数",	
        "采购单价",	"采购中",	"采购金额",	"运输途中",	"运输金额",	"可用库存",	"库存金额",	"估算销量",	"今天销量",	"昨天销量",	"前天销售",	
        "上前销量",	"一周销量",	"两周销量",	"30天销量",	"90天销量",	"今天排名",	"昨天排名",	"前天排名",	"上前排名",	"review评分",	"review个数",	
        "库龄",	"占用资金",	"价格",	"当前库存",	"本地仓库存",	"预警库存",	"购物车锁定",	"转仓库锁定",	"入库中锁定",	"可卖天数",	"可售数量",	
        "预计售完日期",	"产品状态",	"产品活跃度",	"listing状态",	"产品物流属性",	"是否EFN产品",	"不可售数量",	"平台建议补货数量",	"最大货件数量",	
        "渠道SKU首单时间",	"ASIN首单时间",	"是否NARF",	"节日标识",	"Group",
...
#####################
        ...
        data_filter = total_file[["渠道来源","Country","Station","渠道ASIN","唯一","StationASIN","SKU","ASIN","SellSKU","0","1","2","3","4","listing状态","产品活跃度","产品中文名称","Group","销售小组","上架时间",
...
def main():
    ...
    path = r"D:\data\ERP每周批量\部门每周数据待处理"
