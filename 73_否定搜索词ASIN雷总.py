...
# and len(pending_sheet.loc[i,'search_terms_asin大写']) == 10
for i in range(0,len(pending_sheet)):
    if pending_sheet.loc[i,'search_terms_asin大写'][0:2] == 'B0' :
        ...
        for station in station_list:
            ...
            for i in range(0,len(station_sheet)):
                ...
                if station_sheet.loc[i,'Negative_type'] == 'Negative Exact':
                    df.loc[i,'Keyword or Product Targeting'] = station_sheet.loc[i,'search_terms_asin大写']                
                else:
                    df.loc[i,'Product Targeting ID'] = 'asin="' + station_sheet.loc[i,'search_terms_asin大写'] + '"'
